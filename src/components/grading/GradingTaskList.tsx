...
import GradingTaskDetail from './GradingTaskDetail';
...
const GradingTaskList: React.FC = () => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-6">
          <Row justify="space-between" align="middle">
            <Col>
              <h1 className="text-2xl font-bold">阅卷任务管理</h1>
              <p className="text-gray-600 mt-1">创建和管理答题卡阅卷任务</p>
            </Col>
            <Col>
              <Button
                type="primary"
...
export default GradingTaskList;