  ...
  const renderMobileCard = (record: T, index: number) => {
    ...
    return (
      <Card
        ...
        className={cn(cardStyles.base, cardStyles.variants.default, cardStyles.sizes.sm, "mb-3")}
        size="small"
        title={
          <div className="{cn(layout.flex.between())}">
      ...
      >
        ...
        <div className="space-y-2">
          {columns.slice(0, 3).map((col, colIndex) => {
            ...
            return (
              <div key={colIndex} className="{cn(layout.flex.between())} text-sm">
                <span className="text-neutral-500">{col.title as string}:</span>
    ...
    return (
      <div className="space-y-4">
        {columns.map((col, index) => {
          ...
          return (
            <div key={index} className="border-b border-neutral-100 pb-3">
              <div className="text-sm text-neutral-500 mb-1">{col.title as string}</div>
